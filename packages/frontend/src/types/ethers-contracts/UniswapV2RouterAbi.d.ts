...
interface UniswapV2RouterAbiInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapV2RouterAbi extends BaseContract {
  ...
  interface: UniswapV2RouterAbiInterface;
